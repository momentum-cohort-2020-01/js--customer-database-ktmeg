...
console.log(customerPictures)

const img = document.createElement('ul')
for( const img of customerListItems) {
    ul.appendChild(img)
}
document.querySelector('#customers').appendChild(img)



const address = customers.map(function (customer) {
